...
public class CompanyServiceIntegrationTest extends SpringBootCouchApplicationTests {

    public static final String BUILDING_1 = "building::1";
    public static final String COMPANY_2 = "company::2";

    @Autowired
    private CompanyService buildingService;



    @Test
    public void testSave() {
        val building = new Company(BUILDING_1, "couchbase",
                COMPANY_2, new ArrayList<>(), new ArrayList<>());
        buildingService.save(building);

        Company newBuilding = buildingService.findById(BUILDING_1);
        assertThat(newBuilding, equalTo(building));
    }

    @Test(expected = ConstraintViolationException.class)
    public void testSaveWithMissingNameField() {
        val building = new Company("building::1", null,
                COMPANY_2, new ArrayList<>(), new ArrayList<>());
        buildingService.save(building);
    }
    ...
    public void testFindByCompanyId() {
        val building = new Company(BUILDING_1, "building",
                COMPANY_2, new ArrayList<>(), new ArrayList<>());
        buildingService.save(building);
    ...
    public void testFindByCompanyIdAndNameLike() {
        ...
        val building2 = new Company("building::4", "AnotherBuilding",
                COMPANY_2, new ArrayList<>(), new ArrayList<>());
    ...
    public void testFindPhoneNumber() {
        ...
        val building2 = new Company("building::3", "Some other building",
    ...
    public void testCount() {
        val building = new Company(BUILDING_1, "building1",
                COMPANY_2, new ArrayList<>(), new ArrayList<>());
        buildingService.save(building);

        val building2 = new Company("building::4", "building2",
                COMPANY_2, new ArrayList<>(), new ArrayList<>());
        buildingService.save(building2);

        val buildingFromOtherCompany = new Company("building::5", "buildingFromOtherCompany",
